...
public class D3Test {
  ...
  public void tEST6RENT() {
    ...
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(2)")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(), is("ID 3. Mistoffelees"));
    assertThat(driver.findElement(By.xpath("/html/body/div/main/div[1]/div[2]/div[3]/following-sibling::*")).getText(), is("Success!"));
  }
  @Test
  public void tEST7RETURN() {
    ...
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(2)")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(), is("ID 3. Mistoffelees"));
    assertThat(driver.findElement(By.xpath("/html/body/div/main/div[1]/div[3]/div[3]/following-sibling::*")).getText(), is("Success!"));
  }
  @Test
  ...
  public void tEST9FEED() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/div/main/div[1]/div[2]/div[3]/following-sibling::*")).getText(), is("Nom, nom, nom."));
  }
  @Test
  public void tEST10GREETACAT() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[contains(.,\'Meow!Meow!Meow!\')]"));
      assert(elements.size() > 0);
    }
  }
  @Test
  public void tEST11GREETACATWITHNAME() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[contains(., \"Meow! from Jennyanydots.\")]"));
      assert(elements.size() > 0);
    }
  }
}
